...
import com.ablanco.marvellab.features.characters.databinding.FragmentCharacterDetailBinding
...
class CharacterDetailFragment : BaseCollapsingToolbarFragment(R.layout.fragment_character_detail) {
    ...
    private val binding: FragmentCharacterDetailBinding by binding(FragmentCharacterDetailBinding::bind)
    ...
    override fun onViewReady(savedInstanceState: Bundle?, isRestored: Boolean) {
        ...
        binding.rvComics.addOnScrollListener(
            EndScrollListener(
                layoutManager,
        ...
        viewModel.viewState.observe(viewLifecycleOwner, Observer { state ->
            ...
            binding.tvDescription.text = state.character?.character?.description
            binding.tvDescription.switchVisibility(!state.character?.character?.description.isNullOrBlank())
